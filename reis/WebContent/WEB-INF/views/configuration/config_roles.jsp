...
<html lang="ca">
	<head>
	    ...
	    <title>Arxiu Reis d'Igualada :: Gestió perfils</title>
	...
	<body>
				...
				<div class="container">
					<div class="row">
						<div class="col">
				        	...
				        	<div align="right">
								<a href="${contextPath}/configuration/registrationRole" class="btn btn-success">
								    	...
								    	<tr>
								    		...
								    		<td>
								    			<div class="btn-group-xs" role="group">
									    			<a href="${contextPath}/configuration/registrationRole?id=${role.id}" class="btn btn-primary">Editar</a>
									    			<a href="${contextPath}/configuration/deleteRole?id=${role.id}" class="btn btn-danger">Eliminar</a>
									    		</div>
								    		</td>
								    	</tr>
								    </c:forEach>
		...
		<script src="${contextPath}/resources/js/configuration/config_roles.js"></script>
	</body>
</html>
